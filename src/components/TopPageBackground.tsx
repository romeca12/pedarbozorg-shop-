function TopPageBackground() {
    return (
        <div className="inline-block">
            ...
            {/* <img src="./images/flower-content-about-us.svg" alt="گل-1" className="hidden lg:block absolute left-0 top-[1000px]" />
            <img src="./images/flower-content-about-us.svg" alt="گل-2" className="-z-10 hidden lg:block absolute top-[1720px] -right-6 -scale-x-[1]" /> */}
        </div>
    )
}
