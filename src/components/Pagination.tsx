...
const Pagination = ({ count, handleChangePage, currentPage }: IPropsPagination) => {
    ...
    return (
        <div className="flex justify-center items-center gap-2 h-10 text-primary text-sm md:text-base cursor-pointer">
            ...
            {/* {!spaceOne && <span className={`tab-navigation ${NumberCurrentPage === 2 ? "active-tab-navigation" : ""}`} onClick={() => handleChangePage(2)}>{NumberCurrentPage === 4 ? 2 : "..."}</span>} */}
            ...
            {/* <span className={`tab-navigation`} onClick={() => {
                ...
                : NumberCurrentPage + 1 <= 13 ? NumberCurrentPage + 1
                    : ""}</span> */}
            ...
            {/* {!spaceTwo && <span className="tab-navigation" onClick={() => handleChangePage(allPages - 1)}>{NumberCurrentPage === allPages - 3 ? allPages - 1 : "..."}</span>} */}
