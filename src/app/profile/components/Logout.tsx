...
function Logout({popUpLogout, setPopUpLogout} : TPropsLogout) {
    ...
    return (
        <>
            ...
            <div className={`${popUpLogout? "top-1/2" : "top-[120%]"} space-y-6 z-30 pop-up w-full max-w-[498px] bg-white p-6 border-custom rounded-2xl shrink-0 content-center transition-all duration-500`}>
