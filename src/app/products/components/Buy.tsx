                ...
                <section className="xl:w-[370px] fixed xl:static z-[2] gap-y-2 bottom-0 right-0 left-0 w-full bg-white xl:bg-[#ffffff99] py-[17px] px-4 rounded-2xl border-custom flex flex-col items-center">
                    ...
                    <div className="gap-x-2 hidden xl:flex text-2xl text-primary">
                        <div className="flex gap-x-2">
                            <span className="flex items-center gap-x-2"><span className="text-text-gray-two text-base">از</span>۹۳٬۰۰۰</span>
                            <span className="flex items-center gap-x-2"><span className="text-text-gray-two text-base">تا</span>۲٬۰۳۴٬۰۰۰</span>
                        </div>
                        <Image src="/icons/tooman-1.svg" alt="تومان" width={21} height={21} />
                    </div>
                    <div className="flex flex-col gap-y-2 w-full h-28 overflow-y-scroll px-2 xl:h-auto xl:overflow-visible">
                        {Array(3).fill(1).map((_, index) =>
                            <div key={index} className="flex gap-x-2 items-center pt-2 border-t-type-two buy-single-product">
                                ...
                                <div className="flex-1 w-1/2 xl:w-auto flex gap-x-2 justify-end items-center">
                                    ...
                                    <div className="min-w-[51px] h-[72px] flex justify-end items-center">
                                        {addCart[index] === 0 ?
                                            <span
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                <span className="text-[#353535] text-xl pt-0.5 flex justify-center">{addCart[index]}</span>
